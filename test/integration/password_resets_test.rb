...
class PasswordFormTest < PasswordResetForm
  ...
  test "reset with wrong email" do
    get edit_password_reset_path(@reset_user.reset_token, emial: "")
    assert_redirected_to root_url
  end
  ...
  test "resetwith right email but wrong token" do
...
class ExpiredTokenTest < ExpiredToken
  ...
  test "should redirect to the password_reset page" do
